...
import { RuneBridgeTransactionStep } from '../TransactionStep/RuneBridgeTransactionStep';

export type RuneBridgeTransactionStepsProps = {
...
export const RuneBridgeTransactionSteps: FC<
  RuneBridgeTransactionStepsProps
> = ({ transactions, onSuccess, onClose, gasPrice, onTxStatusChange }) => {
