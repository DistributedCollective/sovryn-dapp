...
export const CRITICAL_COLLATERAL_RATIO = numeric(1.5); // 150%
export const MINIMUM_COLLATERAL_RATIO = numeric(1.1); // 110%

export const MIN_DEBT_SIZE = numeric(200); // 200 ZUSD
