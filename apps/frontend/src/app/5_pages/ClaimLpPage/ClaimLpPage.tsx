...
const ClaimLpPage: FC = () => {
  ...
  return (
    <>
      ...
      <div className="w-full flex flex-col items-center text-gray-10 mt-9 sm:mt-24 mb-12">
        ...
        <div className="mt-12 w-full p-0 sm:rounded sm:w-[28rem] py-6 sm:p-6 bg-gray-90">
          <Paragraph
          ...
          <div className="bg-gray-80 p-4 pt-12 mb-12">
