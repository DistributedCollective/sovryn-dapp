  ...
  return (
    <>
      ...
      <div className="w-full flex flex-col items-center text-gray-10 my-9 sm:my-24">
        ...
        <div className="flex flex-col-reverse lg:flex-row lg:space-x-6 xl:w-9/12 w-full h-full">
          <TradingChart pair={renderPair} />

          <div className="lg:mt-12 mt-6 p-0 sm:border sm:border-gray-50 sm:rounded lg:min-w-[28rem] sm:p-6 sm:bg-gray-90 h-fit self-center">
