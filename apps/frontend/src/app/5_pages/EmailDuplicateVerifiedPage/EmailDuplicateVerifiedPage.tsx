...
export const EmailDuplicateVerifiedPage = () => {
  return (
    <>
      <Helmet>
        <title>
          {t(translations.emailNotifications.duplicateVerifiedPage.meta.title)}
        </title>
      </Helmet>
      <div className="w-full flex flex-col items-center justify-center m-auto max-w-[51rem] text-gray-10 px-7 py-11 lg:py-16 bg-gray-90 mt-24 mb-5 lg:mt-[15.875rem] rounded">
        <Heading className="font-medium text-2xl mb-10 lg:mb-12 text-center">
          {t(translations.emailNotifications.duplicateVerifiedPage.title)}
        </Heading>
        <Paragraph className="max-w-xl leading-[1.125rem] font-normal text-sm lg:text-base text-center px-5">
          {t(translations.emailNotifications.duplicateVerifiedPage.subtitle)}
        </Paragraph>
      </div>
    </>
  );
